...
func ReadGraph(filename string) (*Graph, error) {
	...
	tokens = fields(line)
	numOsmNodePoints, err := parseInt(tokens[0])
	if err != nil {
	...
	numIdMapItems, err := parseInt(tokens[0])
	if err != nil {
