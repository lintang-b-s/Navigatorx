...
func addTwoWayTurnCost[W util.RoutingNumber](p *OsmParser[W], wayId int64, way osmWay, outEdges [][]da.OutEdge,
	inEdges [][]da.InEdge, turnMatrices [][]pkg.TurnType, outDegree []int) {
	/*
...
func isParallelEdge(eId, fromResId, q da.Index) bool {
...
func addViaNodeTurnRestriction[W util.RoutingNumber](p *OsmParser[W], wayId int64, way osmWay, fromNodes []da.Index, restriction restriction, fromResId int, outEdges [][]da.OutEdge,
	inEdges [][]da.InEdge, outDegree []int, vertices []da.Vertex, turnMatrices [][]pkg.TurnType, conditionalTurnRestrictions *[]da.ConditionalTurnRestriction) {
	/*
