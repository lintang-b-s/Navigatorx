...
// please run the test using command: "go test ./tests/shortestpath_without_turn_cost  -run TestCRPQueryShoppingMallsMLD  -v -timeout=0  -count=1"
// karena bakal timeout kalau pakai run test vscode
// selesai dalam 1 detik
func TestCRPQueryShoppingMallsMLD(t *testing.T) {
