...
// please run the test using command: "go test ./tests/shortestpath_without_turn_cost -run TestCRPQueryDelftDistanceMLD  -v -timeout=0  -count=1"
// karena bakal timeout kalau pakai run test vscode
// selesai dalam dalam 65 detik
func TestCRPQueryDelftDistanceMLD(t *testing.T) {
